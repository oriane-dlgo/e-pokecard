    ...
    <div class="payment-grid">
        ...
        <div class="payment-card card-credit">
            ...
            <form action="<?= base_url('paiement/process') ?>" method="post">
                ...
                <input type="text" name="cc_num" inputmode="numeric" pattern="[0-9]{16}"
                    placeholder="XXXX XXXX XXXX XXXX" class="pay-input" required>

                <div class="pay-row">
                    <div style="flex:1">
                        <label>EXP</label>
                        <input type="text" name="cc_exp" placeholder="MM/YY" pattern="(0[1-9]|1[0-2])/[2-9][0-9]"
                            class="pay-input" required>
                    </div>
                    <div style="flex:1">
                        <label>CVV</label>
                        <input type="text" inputmode="numeric" pattern="[0-9]{3}" name="cc_cvv" placeholder="123"
                            class="pay-input" required>
                    </div>
                </div>
