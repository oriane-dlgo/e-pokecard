...
<?= $this->section('contenu') ?>
    ...
    <div class="payment-container">
        ...
        <?php if(session()->getFlashdata('msg')):?>
            <div style="background: #000; color: #ff3333; border: 4px solid #ff3333; padding: 15px; margin: 15px 0; font-weight: bold; text-align: center; text-transform: uppercase; font-size: 20px;">
                ⚠️ ERREUR : <?= session()->getFlashdata('msg') ?>
            </div>
        <?php endif;?>
