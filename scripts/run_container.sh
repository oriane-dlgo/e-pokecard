...
podman exec -it sae_php_app chmod -R 755 /var/www/html || echo "--  Petit souci de permission ignoré"
podman exec -it sae_php_app chmod -R 777 /var/www/html/writable || echo "--  Petit souci de permission ignoré"
podman exec -it sae_php_app chmod -R 777 /var/www/html/public/assets || echo "--  Petit souci de permission ignoré"
