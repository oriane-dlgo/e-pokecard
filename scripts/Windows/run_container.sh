...
docker exec -i sae_php_app chmod -R 755 /var/www/html || echo "⚠️  Petit souci de permission ignoré"
docker exec -i sae_php_app chmod -R 777 /var/www/html/writable || echo "⚠️  Ignoré sous Windows"
docker exec -i sae_php_app chmod -R 777 /var/www/html/public/assets || echo "⚠️  Ignoré sous Windows"
